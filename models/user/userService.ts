...
import kakaoAPI from "../kakao/kakaoService";
...
class userService {
    private kakaoServiceInstance: kakaoAPI;
    private userDAOInstance: userDAO;
    #saltRounds;
    constructor(kakaoServiceInstance: kakaoAPI, userDAOInstance: userDAO) {
        this.#saltRounds = 10;
    ...
    async checkValidation(id, address, pw, pwc) {
        ...
        const user = await this.userDAOInstance.findById(id);
